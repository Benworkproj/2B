...
<head>
	...
	<title>Course - Archieved Course</title>
	<!-- Bootstrap File CSS -->
		...
		<div class="row">
					...
					<div class="col-12 navigation-list">
						<ul>
							...
							<div class="sub-menu">
								...
								<a href="#"><li><p>Archived Courses</p></li></a>
							</div>
						</ul>
					</div>
				</div>
			...
			<div class="col-9 bottom-right" style="background-color: #FBFAF2; min-height: 85vh;">
				<div class="container-fluid content">
					<div class="col-12 hello"><i class="fa-solid fa-briefcase"></i><span>Course - <span class="text-success">Archived Courses</span></span><hr></div> 		
				</div>

				<!-- ----------------------------------------------------- Make Course Available Modal ---------------------------------------------------- -->
				<div class="modal fade" id="ReturnCourse" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
      			  	<div class="modal-dialog modal-dialog-centered">
      			    	<div class="modal-content">
      			      		<div class="modal-header">
      			        		<h5 class="modal-title" id="exampleModalToggleLabel">Make Course Available</h5>
      			      		...
      			      		<form action="" method="POST">
	      			      		<div class="modal-body">
		      			        	...
		      			        	<h4 class="text-center text-danger">Are you sure you want to make this course available again?</h4>
		      			        	<p class="text-center mt-3 mx-3"><span class="text-warning">Note:</span> This will make the course available and students will be able to apply for this course again</p>		
	      			      		</div>

		      			      	<div class="modal-footer">						  
		      			        	<button class="btn btn-success col-12 col-sm-5"><i class="fa-solid fa-rotate-left me-2"></i>Return Course</button>
      			...
      			<!-- -------------------------------------------------- End of Make Course Available Modal --------------------------------------------------- -->

				<!-- ----------------------------------------------------- Delete Course Modal ---------------------------------------------------- -->
				<div class="modal fade" id="DeleteCourse" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
      			  	<div class="modal-dialog modal-dialog-centered">
      			    	<div class="modal-content">
      			      		<div class="modal-header">
      			        		<h5 class="modal-title" id="exampleModalToggleLabel">Delete Course</h5>
      			        		<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      			      		</div>
      			      		...
      			      		<form action="" method="POST">
	      			      		<div class="modal-body">
	      			      			<div class="text-center mb-3"><i class="fa-solid fa-triangle-exclamation fa-beat text-warning display-3"></i></div>	      			     	    
		      			        	<h4 class="text-center text-danger">Are you sure you want to Delete this course forever?</h4>
		      			        	<p class="text-center mt-3 mx-3"><span class="text-warning">Note:</span> This will permanently delete the course and will never be available again</p>				      			    				      			     
	      			      		</div>

		      			      	<div class="modal-footer">						  
		      			        	<button class="btn btn-success col-12 col-sm-5"><i class="fa-solid fa-trash me-2"></i>Delete Course</button>
		      			        	<button class="btn btn-danger col-12 col-sm-3" data-bs-dismiss="modal"><i class="fa-solid fa-xmark me-2"></i></i>Cancel</button>
		      			      	</div>
		      			    </form>
      			  		</div>
					...
					<table class="table table-striped table-bordered pt-3 mb-3 table-fluid" id="myTable">
					  	...
					  	<tbody>
					    	<tr>
					      		...
					      		<td>
					      			<button type="button" class="btn btn-primary px-2 py-0 mx-1" data-bs-target="#ReturnCourse" data-bs-toggle="modal"><i class="fa-solid fa-rotate-left"></i></button>
					      			<button type="button" class="btn btn-danger px-2 py-0 mx-1" data-bs-target="#DeleteCourse" data-bs-toggle="modal"><i class="fa-solid fa-trash-can"></i></button>
					      		</td>     			
					    	</tr>
					 	</tbody>
					</table>
