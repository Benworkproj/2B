...
<head>
	...
	<title>Messages - New Messages</title>
	<!-- Bootstrap File CSS -->
		...
		<div class="row">
				...
				<div class="row">
					<div class="col-12 navigation-list">
						<ul>
							...
							<div class="sub-menu">
								<a href="#"><li><p>New Messages</p></li></a>
			...
			<div class="col-9 bottom-right" style="background-color: #FBFAF2; min-height: 85vh;">
				<div class="container-fluid content">
					<div class="col-12 hello"><i class="fa-solid fa-envelope"></i><span>Messages - <span class="text-primary">New Messages</span></span><hr></div> 		
				</div>
						...
						<div class="modal-content">
							<div class="modal-header">
	      			      	...
	      			      	<div class="modal-footer">						  
	      			        	<button class="btn btn-success col-12 col-sm-3" data-bs-target="#ReplyMessage" data-bs-toggle="modal" data-bs-dismiss="modal"><i class="fa-solid fa-reply me-2"></i>Reply</button>
      			    	...
      			    	<div class="modal-content">
      			      		...
      			      		<form action="" method="POST">
	      			      		<div class="modal-body">
		      			        	...
		      			        	<p class="text-center mt-3 mx-3"><span class="text-warning">Note:</span> This will permanently delete this Message and will never be available to reply or view again</p>				      			    				      			     
	      			      		</div>
				...
				<!-- ------------------------------------------------------------- Reply Message Modal -------------------------------------------------------- -->		
				<div class="modal fade" id="ReplyMessage" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalToggleLabel2">Reply Message</h5>
								<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
							</div>
							...
							<form action="" method="POST">
	      			      		<div class="modal-body">
	      			      			...
	      			      			<div class="mb-2">
	      			      				...
	      			      				<input type="text" class="form-control bg-light" placeholder="Write a subject.........">
	      			      			</div>

	      			      			<div class="mb-2">
	      			      				<label class="form-label">Reply Message:</label>
	      			      				<textarea class="form-control reply" id="message-text" placeholder="Write a message........."></textarea>
	      			      			</div>					      			        				      			        
		      			        					      			    				      			     
	      			      		</div>

		      			      	<div class="modal-footer">						  
		      			        	<button class="btn btn-success col-12 col-sm-3"><i class="fa-solid fa-paper-plane me-2"></i>Send</button></form>
		      			        	<button class="btn btn-danger col-12 col-sm-3"  data-bs-dismiss="modal"><i class="fa-solid fa-xmark me-2"></i></i>Cancel</button>
		      			      	</div>	
						</div>
					</div>
				</div>
				<!-- ----------------------------------------------------------- End of Reply Message Modal ---------------------------------------------- -->
