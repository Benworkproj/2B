		...
		<div class="row">
				...
				<div class="row">
					<div class="col-12 navigation-list">
						<ul>
							...
							<div class="sub-menu">
								<a href="#"><li><p>Student Users</p></li></a>
			...
			<div class="col-9 bottom-right" style="background-color: #FBFAF2; min-height: 85vh;">
				<div class="container-fluid content">
					<div class="col-12 hello"><i class="fa-solid fa-users"></i><span>Registered Users - <span class="text-primary">Students</span></span><hr></div> 		
				</div>
      			  	...
      			  	<div class="modal-dialog modal-dialog-centered">
      			    	<div class="modal-content">
      			      		<div class="modal-header">
      			        		<h5 class="modal-title" id="exampleModalToggleLabel">Edit Student Account Details</h5>
      			    	...
      			    	<div class="modal-content">
      			      		...
      			      		<form action="" method="POST">
	      			      		<div class="modal-body">
		      			        	...
		      			        	<h4 class="text-center text-danger">Are you sure you want to delete this Student User Account forever?</h4>
					...
					<table class="table table-striped table-bordered pt-3 mb-3 table-fluid" id="myTable">
					  	...
					  	<tbody>
					    	<tr>
					      		...
					      		<td>
					      			<button type="button" class="btn btn-primary px-2 py-0 mx-1" data-bs-target="#EditUsersAccount" data-bs-toggle="modal"><i class="fa-solid fa-pen-to-square"></i></button> 
